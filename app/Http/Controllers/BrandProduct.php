...
class BrandProduct extends Controller
{
    ...
    public function unactive_brand_product($brand_id){
        ...
        Session::put('message','Thay đổi trạng thái của thương hiệu sản phẩm thành công');
    ...
    public function update_brand_product(Request $request, $brand_id){
        ...
        Session::put('message','Cập nhật thương hiệu sản phẩm sản phẩm thành công');
        return Redirect::to('all-brand-product');
    }
    ...
    public function show_brand_home(Request $request, $brand_id){
        ...
        return view('pages.brand.show_brand')->with('category',$cate_product)->with('brand',$brand_product)->with('brand_by_id',$brand_by_id)->with('all_product',$all_product)->with('brand_name',$brand_name)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical);
    }
}
