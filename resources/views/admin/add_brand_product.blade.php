                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Từ khoá thương thương hiệu</label>
                                    <input type="text" name="meta_keywords" class="form-control" id="exampleInputEmail1" placeholder="Tên thương hiệu">
                                </div>
