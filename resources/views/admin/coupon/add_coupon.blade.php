                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('/insert-coupon')}}" method="post">
                                    @csrf
                                ...
                                <div class="form-group">
                                   ...
                                   <input type="number" name="coupon_time" class="form-control" id="exampleInputEmail1" min="0">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="coupon_condition" class="form-control m-bot15">
                                        ...
                                        <option value="1">Tính theo %</option>
                                        <option value="2">Tính theo tiền giảm</option>
                                    </select>
                                </div>
